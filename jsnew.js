...
const app = {
    ...
    appVars: function() {
        this.horoscope = {
            url: "https://confused-closet.glitch.me/api",
            //"https://horoscope-ph.herokuapp.com/",
            current_date: null,
            date: null,
            sunSign: null,
            color: null,
    ...
    moveWheel: function(endPos, sign) {
        ...
        let wheelMoveKeyframes = new KeyframeEffect(
            ...
            { easing: "ease-in-out", duration: 3000, fill: "forwards" }
        );
    ...
    getHoroscope: function() {
        ...
        URL = `${this.horoscope.url}/${sign}/${this.getDay()}`;
        fetch(URL, {
            method: "GET"
        })
            ...
            .then(json => {
            console.log(json)
            this.horoscope.date = json.date;
            this.horoscope.color = json.color;
            this.horoscope.description = json.description;
            this.horoscope.date_range = `${json.sign.start} thru ${json.sign.end}`;
            this.sunSign.innerHTML = `${json.sign.name} ${this.horoscope.date_range}`;
